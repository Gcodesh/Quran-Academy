...
ALTER TABLE lessons ADD COLUMN IF NOT EXISTS section_id INT NULL AFTER course_id;
ALTER TABLE lessons ADD COLUMN IF NOT EXISTS lesson_type ENUM('lecture', 'quiz', 'assignment', 'reading', 'exam') DEFAULT 'lecture' AFTER title;
...
ALTER TABLE lessons ADD COLUMN IF NOT EXISTS duration INT DEFAULT 0; -- in seconds
