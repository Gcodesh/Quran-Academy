...
ALTER TABLE lessons ADD COLUMN status ENUM('draft', 'review', 'published', 'rejected') DEFAULT 'draft' AFTER order_number;
ALTER TABLE lessons ADD COLUMN moderation_notes TEXT AFTER status;
